...
/* harmony import */ var _common_cdn__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ..//common/cdn */ "./src/common/cdn.js");


flarum_admin_app__WEBPACK_IMPORTED_MODULE_0___default().initializers.add('flarum-emoji', function () {
  flarum_admin_app__WEBPACK_IMPORTED_MODULE_0___default().extensionData["for"]('flarum-emoji')

  // add a cdn address to the settings page
  .registerSetting({
    setting: 'flarum-emoji.cdn',
    type: 'text',
    label: flarum_admin_app__WEBPACK_IMPORTED_MODULE_0___default().translator.trans('flarum-emoji.admin.settings.cdn_label'),
    help: flarum_admin_app__WEBPACK_IMPORTED_MODULE_0___default().translator.trans('flarum-emoji.admin.settings.cdn_help', {
      version: _common_cdn__WEBPACK_IMPORTED_MODULE_1__.version
    })
  });
});
